...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    companyImage: Schema.Attribute.Media<'images'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['News', 'Insights', 'Press Release', 'Case Study']
    > &
...
export interface ApiBusinessPartnershipBusinessPartnership
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::business-partnership.business-partnership'
    > &
      Schema.Attribute.Private;
...
export interface ApiGlobalBusinessGlobalBusiness
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::global-business.global-business'
    > &
      Schema.Attribute.Private;
    pageDescription: Schema.Attribute.RichText;
    pageTitle: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    regions: Schema.Attribute.Component<'sections.feature-card', true>;
    sections: Schema.Attribute.Component<'sections.content-block', true>;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiNewsInsightsPageNewsInsightsPage
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::news-insights-page.news-insights-page'
    > &
      Schema.Attribute.Private;
