...
exports.HOME_CONTACT_CTA_DEFAULTS = exports.HOME_NEWS_DEFAULTS = exports.HOME_PRODUCTS_SECTION_DEFAULTS = exports.HOME_PRODUCTS_DEFAULTS = exports.HOME_CORE_ADV_DEFAULTS = exports.HOME_HERO_DEFAULTS = void 0;
/** 首页各区预设（Strapi 未填或离线时使用） */
exports.HOME_HERO_DEFAULTS = {
...
exports.HOME_CORE_ADV_DEFAULTS = {
...
exports.HOME_PRODUCTS_DEFAULTS = [
    {
        slug: 'trading-solution',
        title: '机构解决方案',
        subtitle: '机构解决方案',
        description: '券商基础设施：为券商提供稳定、高效、安全的交易、报价与结算系统，支持全球多市场接入。',
        icon: 'institutional',
    ...
    },
    {
        ...
        title: '创新金融科技',
        subtitle: '创新金融科技',
        description: '虚拟资产与量化交易，提供符合香港监管要求的虚拟资产交易解决方案，以及强大的n2nquant量化平台，把握新兴市场机遇。',
        icon: 'fintech',
    ...
    },
    {
        ...
        title: '个人投资者工具',
        subtitle: '个人投资者工具',
        description: '个人投资利器，股市宝SMP5功能丰富实用，策略助手Master Picks集成各流派分析框架，为个人投资者提供专业级的数据与决策支持。',
        icon: 'retail',
        coverImage: '/about/geometric-building2.jpg',
    },
    {
...
exports.HOME_PRODUCTS_SECTION_DEFAULTS = {
    moduleLabel: 'Module 03',
    titleZh: '产品与服务',
    titleEn: 'Products & Services',
};
exports.HOME_NEWS_DEFAULTS = {
...
exports.HOME_CONTACT_CTA_DEFAULTS = {
    title: '联系 N2N Connect，开启降本增效与业务增长新模式',
    description: '超越传统 IT 供应商，以领先金融科技提供高性价比、高效能，多市场、多业务的一站式灵活客制化服务。',
    buttonLabel: '联系我们',
    buttonLink: '/contact',
