...
exports.pressAndAnnouncementArticles = void 0;
exports.pressAndAnnouncementArticles = [
    {
        ...
        content: '<p>N2N Connect Berhad 发布本一般公告，以便股东与市场参与者了解最新公司发展与业务重点。</p><p>更多细节可通过马来西亚交易所公告及官方投资者沟通渠道获取。</p>',
    },
    {
        ...
        content: '<p>本公告概述与股东及潜在投资者相关的最新经营进展与财务更新。</p><p>公司将继续聚焦可持续增长与稳健执行。</p>',
    },
    {
        ...
        content: '<p>N2N 集团持续支持教育与产业协作项目，培育面向未来的技术人才与科技驱动增长。</p>',
    },
    {
        ...
        content: '<p>访谈凸显 N2N 对资本市场技术、创新与区域拓展的长期承诺。</p>',
    },
    {
        ...
        content: '<p>本稿梳理战略合作更新，以及公司通过技术伙伴关系强化市场地位的进展。</p>',
    },
    {
        ...
        content: '<p>N2N 的平台与产品路线图随资本市场需求变化与数字化转型持续演进。</p>',
    },
];
