...
exports.TRADING_SOLUTION_FEATURE_ROWS = exports.TRADING_SOLUTION_SIX_GRID = exports.TRADING_SOLUTION_FOOTER_CTA_DEFAULT = exports.TRADING_SOLUTION_SPOTLIGHT = exports.TRADING_SOLUTION_HERO = exports.TRADING_SOLUTION_BACK_FEATURES = exports.TRADING_SOLUTION_FRONT_FEATURES = void 0;
const ICON = (name) => `/trading-solution/front-office-icons/${name}`;
const ICON_BO = (name) => `/trading-solution/back-office-icons/${name}`;
exports.TRADING_SOLUTION_FRONT_FEATURES = [
    {
        icon: ICON('buy_sell_icon.png'),
        title: '零售与机构交易',
        description: '亚太区备受青睐的交易解决方案，覆盖全球各类交易场景与客户类型。',
    },
    {
        icon: ICON('order_icon.png'),
        title: '客户订单管理',
        description: '安全、高效、经济地执行证券订单，并覆盖盘前流程与持仓管理。',
    },
    {
        icon: ICON('profit_loss_icon.png'),
        title: '盈亏管理',
        description: '协助您统筹营收与成本，深入细节并获取经营洞察。',
    },
    {
        icon: ICON('algo_icon.png'),
        title: '程序化交易',
        description: '全自动、可预设的交易指令，速度与处理能力出众，紧跟市场趋势。',
    },
    {
        icon: ICON('analytic_icon.png'),
        title: '分析与图表',
        description: '面向成熟投资者：逾百种图表与指标、十余年历史数据、图表内下单等能力。',
    },
    {
        icon: ICON('low_latency_icon.png'),
        title: '低延迟直连市场（DMA）',
        description: '依托区域内广泛且优化的网络，提供极速直连市场交易体验。',
    },
    {
        icon: ICON('news_icon.png'),
        title: '新闻与基本面',
        description: '整合区域与本地资讯来源，帮助投资者做出更明智的交易决策。',
    },
    {
        icon: ICON('smart_order_icon.png'),
        title: '智能订单路由',
        description: '依您自定义规则，自动将订单路由至当前最优机会。',
    },
];
exports.TRADING_SOLUTION_BACK_FEATURES = [
    {
        icon: ICON_BO('data_reconciliation.png'),
        title: '数据核对',
        description: '顺畅完成数据迁移；运用数学模型校验，降低过程中的数据遗漏风险。',
    },
    {
        icon: ICON_BO('trade_settelment.png'),
        title: '交易结算',
        description: '高效结算是常态，算法公式助力确保计算准确、流程省时。',
    },
    {
...
/** 首页式 Hero 说明（全宽横幅用） */
exports.TRADING_SOLUTION_HERO = {
    title: '交易解决方案',
    subtitle: 'N2N 为券商与机构客户提供整合前台交易与后台结算的一站式平台，涵盖多资产、多市场与多币种，稳定、安全、可扩展。',
};
/** Hero 下方主视觉区（左图右文，对齐设计稿） */
exports.TRADING_SOLUTION_SPOTLIGHT = {
    title: '整合证券交易与结算',
...
exports.TRADING_SOLUTION_SIX_GRID = [
    {
        iconId: 'clock',
        title: '超低延迟',
 ...
 * 内容对齐业务提供的产品模组说明
 */
exports.TRADING_SOLUTION_FEATURE_ROWS = [
    {
